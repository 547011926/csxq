...
//  
    ...
    function createConfirm(data) {
        ...
        var mask = document.createElement("div"),
            ...
            determine = document.createElement("div"),
        ...
        mask.appendChild(prompt);
        body.appendChild(mask);
        innertext.innerHTML = data.content;
        prompt.appendChild(innertext);
        determine.className = "determine";
        determine.innerHTML = "下载";
        prompt.appendChild(determine);
        ...
        Img.src = "images/01.png";
        prompt.appendChild(Img);
        cancel.innerHTML = data.optional;
        cancel.className = "cancel";
        Determine.innerHTML = "确认";
        Determine.className = "Determine";
        with (Img.style) {
        ...
        if (data.optional == null || data.optional == undefined) {
            Determine.style.width = "100%";
            Determine.style.borderRadius="10rem";
            cancel.style.display = "none";
        }
        cancel.onclick = function () {
            if (data.cancelFunc == null) {
                mask.style.display = "none";
            }
            else {
                data.cancelFunc();
